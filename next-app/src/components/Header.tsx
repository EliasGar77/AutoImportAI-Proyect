    ...
    <header className="h-[90px] absolute top-0 left-0 w-full z-50 transition-all">
      <div className="container mx-auto px-8 flex justify-between items-center h-full max-w-[1400px]">
        ...
        <div className="flex-1 flex justify-end gap-5 items-center">
          {/* Instagram Icon */}
          <a href="https://www.instagram.com/autoimportnextgen" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-500 hover:text-[#E1306C] transition-colors font-medium text-[14px]">
            ...
            <span className="hidden lg:inline">@autoimportnextgen</span>
          </a>
